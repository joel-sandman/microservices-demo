...
def plot_network_traffic_reduction_by_size():
    ...
    plt.legend()
    plt.show()
    # plt.savefig('plots/plot_network_traffic_reduction_by_size.svg', bbox_inches='tight')
...
def plot_data_staleness_by_requests():
    ...
    plt.legend()
    plt.show()
    # plt.savefig('plots/plot_data_staleness_by_requests.svg', bbox_inches='tight')
...
def plot_data_staleness_by_size():
    ...
    plt.legend()
    plt.show()
    # plt.savefig('plots/plot_data_staleness_by_size.svg', bbox_inches='tight')
...
def plot_memory_usage():
    ...
    plt.legend()
    plt.show()
    # plt.savefig('plots/plot_memory_usage.svg', bbox_inches='tight')
